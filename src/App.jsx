            ...
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="bg-gray-100 border-b border-gray-300">
                  <th className="p-2 text-left sticky left-0 bg-gray-100 min-w-[60px] border-r border-gray-300">Time</th>
                  {days.map((day, idx) => {
                ...
                {timeSlots.map((time, timeIdx) => {
                  ...
                  return (
                    <tr key={timeIdx} className="border-b border-gray-200">
                      <td className="p-2 font-semibold text-gray-600 sticky left-0 bg-white min-w-[60px] border-r border-gray-300 align-top">
